...
def p_ampere_minted_amount(params, substep, state_history, previous_state):
    ...
    ampere_minted_amount = math.floor((hydrogen_for_minting / params['ampere_base_investmint_amount']) * \
                                    (investmint_max_period / params['ampere_base_investmint_period']) * previous_state['ampere_mint_rate'])
...
def p_volt_minted_amount(params, substep, state_history, previous_state):
    ...
    investmint_max_period = math.floor(params['investmint_period_share'] * previous_state['investmint_max_period'])
    volt_minted_amount = math.floor((hydrogen_for_minting / params['volt_base_investmint_amount']) * \
